      ...
      default:
        return (
          <>
            ...
            <section id="product" className="py-24 md:py-32 bg-condor-black scroll-mt-24">
              <ProductIntro />
            </section>
            <section id="catalog" className="py-12 md:py-24 bg-condor-charcoal scroll-mt-24 flex items-center">
              <ProductShowcase onNavigate={navigateTo} />
            </section>
            <section id="approach" className="py-24 md:py-32 bg-condor-offwhite text-condor-black scroll-mt-24">
              <Philosophy />
            </section>
            <section id="origin" className="py-24 md:py-32 bg-condor-black scroll-mt-24">
              <Origin />
            </section>
          </>
        );
